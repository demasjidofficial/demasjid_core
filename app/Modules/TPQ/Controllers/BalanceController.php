...
class BalanceController extends AdminCrudController
{
    ...
    protected $baseRoute = ADMIN_AREA.'/tpq/balance';
    ...
    protected function getDataEdit($id = null)
    {
        ...
        $dataEdit['chart_of_accountItems'] = Arr::pluck(model('App\Modules\Api\Models\ChartOfAccountModel')->select(['id as key','name as text'])->tpq()->asArray()->findAllExcludeJoin(), 'text', 'key');
        return $dataEdit;
    }
}
