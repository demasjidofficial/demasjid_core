...
class PelajaranController extends AdminCrudController
{
    ...
    protected function getDataIndex()
    {
        ...
        return [
            'headers' => [
                ...
                'name' => lang('crud.name'),
                'category_id' => lang('crud.kategori_pelajaran_id'),
    ...
    protected function getDataEdit($id = null)
    {
        ...
        $dataEdit['kategori_pelajaranItems'] = Arr::pluck(model('App\Modules\Api\Models\KategoriPelajaranModel')->select(['kategori_pelajaran.id as key','kategori_pelajaran.name as text'])->asArray()->findAllExcludeJoin(), 'text', 'key');
