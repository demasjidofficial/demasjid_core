...
//use App\Modules\Api\Models\ProfilesModel;
//use App\Modules\Pesantren\Models\ProfilesFilter;
//use IlluminateAgnostic\Arr\Support\Arr;

class _ProfilesController extends AdminCrudController
{
    ...
    //protected $modelName = 'App\Modules\Api\Models\ProfilesModel';
    public function index(){
        //return parent::index();
        return $this->render('App\Modules\Pesantren\Views\_submodules\profiles',[]);
    }
    ...
    */
    ...
    protected function getDataIndex()
    {
        ...
        $model = model(ProfilesFilter::class);
        $model->masjid();
    ...
    protected function getDataEdit($id = null)
    {
        ...
        if(!empty($id)){
            ...
            $dataEdit['account_balanceItems'] = Arr::pluck(model('App\Modules\Api\Models\AccountProfilesModel')->select(['account_balance.id as key', 'account_balance.name as text'])->masjid()->asArray()->findAllExcludeJoin(), 'text', 'key');
