        ...
        <div class="row">
            <div class="col-md-3">
                <div class="small-box bg-info">
                    ...
                    <a href="<?= site_url('/admin/pesantren/profile')?>" class="small-box-footer">
            ...
            <div class="col-md-3">
                <div class="small-box bg-warning">
                    ...
                    <a href="<?= site_url('/admin/pesantren/pengurus')?>" class="small-box-footer">
                        <?= lang('app.more_info')?> <i class="fas fa-arrow-circle-right"></i>
                    </a>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="small-box bg-purple">
                    ...
                    <a href="< ?= site_url('/admin/pesantren/entity')?>" class="small-box-footer">
                        < ?= lang('app.more_info')?> <i class="fas fa-arrow-circle-right"></i>
                    </a>
                </div>
            </div>
