        ...
        <div class="row">
            <div class="col-md-3">
                <div class="small-box bg-info">
                    ...
                    <a href="<?= site_url('/admin/pesantren/kelas')?>" class="small-box-footer">
            ...
            <div class="col-md-3">
                <div class="small-box bg-warning">
                    ...
                    <a href="<?= site_url('/admin/pesantren/kategoripelajaran')?>" class="small-box-footer">
                        <?= lang('app.more_info')?> <i class="fas fa-arrow-circle-right"></i>
                    </a>
                </div>
            </div>
            <div class="col-md-3">
                <div class="small-box bg-purple">
                    ...
                    <a href="<?= site_url('/admin/pesantren/pelajaran')?>" class="small-box-footer">
                        <?= lang('app.more_info')?> <i class="fas fa-arrow-circle-right"></i>
                    </a>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="small-box bg-secondary">
                    ...
                    <a href="<?= site_url('/admin/pesantren/bab')?>" class="small-box-footer">
                        <?= lang('app.more_info')?> <i class="fas fa-arrow-circle-right"></i>
                    </a>
                </div>
            </div>
            <div class="col-md-3">
                <div class="small-box bg-success">
                    ...
                    <a href="<?= site_url('/admin/pesantren/materi')?>" class="small-box-footer">
                        <?= lang('app.more_info')?> <i class="fas fa-arrow-circle-right"></i>
                    </a>
                </div>
            </div>
