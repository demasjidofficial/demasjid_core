        ...
        <div class="row">
            <div class="col-3 col-sm-3">
                <div class="small-box bg-info">
                    ...
                    <a href="<?= site_url('/admin/pesantren/schedulelessonweekly')?>" class="small-box-footer">
            ...
            <div class="col-3 col-sm-3">
                <div class="small-box bg-warning">
                    ...
                    <a href="<?= site_url('/admin/pesantren/scheduleacademiccalendar')?>" class="small-box-footer">
                        <?= lang('app.more_info')?> <i class="fas fa-arrow-circle-right"></i>
                    </a>
                </div>
            </div>
            <div class="col-3 col-sm-3">
                <div class="small-box bg-purple">
                    ...
                    <a href="<?= site_url('/admin/pesantren/schedulelessontest')?>" class="small-box-footer">
                        <?= lang('app.more_info')?> <i class="fas fa-arrow-circle-right"></i>
                    </a>
                </div>
            </div>
            <div class="col-3 col-sm-3">
                <div class="small-box bg-success">
                    ...
                    <a href="<?= site_url('/admin/pesantren/schedulelessontestsemester')?>" class="small-box-footer">
                        <?= lang('app.more_info')?> <i class="fas fa-arrow-circle-right"></i>
                    </a>
                </div>
            </div>
