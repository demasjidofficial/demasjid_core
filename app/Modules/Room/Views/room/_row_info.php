<!-- <td>< ?php echo esc($item->gambar) ?></a></td> -->
<td><img width="100px" src="/<?php echo ($item->gambar)? esc($item->gambar) : 'uploads/images/blank.jpg' ?>"></a></td>
<td><?php echo esc($item->namaruangan) ?></a></td>
<td><?php echo esc($item->deskripsi) ?></a></td>
