...
class NonRawatibScheduleCloneModel extends BaseModel
{
    protected $table = 'non_rawatib_schedule_clone';
    protected $returnType = 'App\Modules\Api\Entities\NonRawatibScheduleClone';
    ...
    protected $validationRules = [
        'id' => 'numeric|required|is_unique[non_rawatib_schedule_clone.id,id,{id}]',
