...
* @OA\Tag(
*     name="Siswa",
*     description="Everything about your Siswa" 
* )
*/ 
class Siswa extends BaseEntity
{
    	/**
	 * @OA\Property(		 		 		 
	 *     description="id",
 ...
 * @OA\RequestBody(
 *     request="Siswa",
 *     description="Siswa object that needs to be added", 
 *     @OA\JsonContent(ref="#/components/schemas/Siswa"),
 *     @OA\MediaType(
 *         mediaType="application/x-www-form-urlencoded",
 *         @OA\Schema(ref="#/components/schemas/Siswa")
 *     ),
 *     @OA\MediaType(
