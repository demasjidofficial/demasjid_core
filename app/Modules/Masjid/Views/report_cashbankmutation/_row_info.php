...
<td class="text-right"><?php echo ($item->type == 'debit' ? local_currency($item->amount, 'IDR', null, 2) : '') ?></td>
<td class="text-right"><?php echo ($item->type == 'credit' ? local_currency($item->amount, 'IDR', null, 2) : '') ?></td>
