...
use App\Modules\Api\Models\TimStaffModel_;
use App\Modules\Api\Models\TugasTimModel;
use App\Modules\BaitulMal\Models\TimStaffFilter;
use IlluminateAgnostic\Arr\Support\Arr;

class TimStaffController_ extends AdminCrudController
{
    protected $baseController = __CLASS__;
    protected $viewPrefix = 'App\Modules\BaitulMal\Views\tim_staff_\\';
    protected $baseRoute = 'admin/baitulmal/timstaff_';
    protected $langModel = 'tim_staff';
    protected $modelName = 'App\Modules\Api\Models\TimStaffModel_';
