...
<?php $this->section('main'); ?>
    <x-page-head>
        ...
        <h4><?php echo isset($data) ? '<i class="fa fa-pencil"></i>' : '<i class="fa fa-plus"></i>' ?>  <?= lang('crud.master_ewallet') ?></h4>
    </x-page-head>

    <?php if (isset($data) && null !== $data->deleted_at) { ?>
        <div class="alert danger">
            This <?= lang('crud.master_ewallet') ?> was deleted on <?php echo $data->deleted_at->humanize(); ?>.
            <a href="#">Restore <?= lang('crud.master_ewallet') ?>?</a>
        </div>
    <?php } ?>
            ...
            <fieldset>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        ...
                        <p class="text-danger"><?php echo error('nama_ewallet'); ?></p>
                        <?php } ?>
                    </div>
                </div>
            </fieldset>
