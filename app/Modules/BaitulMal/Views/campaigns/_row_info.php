...
<td><?php echo esc($item->is_active) ?></a></td>
<td><?php echo esc($item->is_delete) ?></a></td>
<td><?php echo esc($item->created_by) ?></a></td>
<td><?php echo esc($item->create_date) ?></a></td>
<td><?php echo esc($item->modified_by) ?></a></td>
<td><?php echo esc($item->modified_date) ?></a></td>
