    ...
    <x-admin-box>
        ...
        <form action="<?php echo $actionUrl; ?>" method="post" enctype="multipart/form-data">
            ...
            <fieldset>
                    ...
                    <div class="col-sm-10">
                        <?= form_dropdown('id_donatur',$donatur_typeItems ,old('id_donatur', $data->id_donatur ?? ''), "class='form-control select2' required placeholder='".lang('crud.id_donatur')."' ") ?>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <?= form_dropdown('id_pembayaran',$pembayaranItems ,old('id_pembayaran', $data->id_pembayaran ?? ''), "class='form-control select2' required placeholder='".lang('crud.id_pembayaran')."' ") ?>
