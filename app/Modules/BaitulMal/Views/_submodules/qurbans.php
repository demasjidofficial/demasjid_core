        ...
        <div class="row">
            <div class="col-md-3">
                <div class="small-box bg-info">
                    <div class="inner">
                    <h3>&nbsp;</h3>
                    <p><?= lang('crud.qurban_category')?></p>
                    </div>
                    <div class="icon">
                    <i class="fas fa-file"></i>
                    </div>
                    <a href="<?= site_url('/admin/baitulmal/qurbancategory')?>" class="small-box-footer">
            ...
            <div class="col-md-3">
                <div class="small-box bg-warning">
                    ...
                    <a href="<?= site_url('/admin/baitulmal/qurban')?>" class="small-box-footer">
                        <?= lang('app.more_info')?> <i class="fas fa-arrow-circle-right"></i>
                    </a>
                </div>
            </div>
