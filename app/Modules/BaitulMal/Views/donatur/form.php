...
<?php echo asset_link('admin/theme-adminlte/plugins/webcam/webcam.min.js', 'js'); ?>
...
<script type="text/javascript">
    ...
    // $('#add_donatur').on('submit', function (event) {
    // 		event.preventDefault();
    // 		var image_path = img_path;
    //         var sign_path=signautre_path
    ...
    // 			type: 'POST',
    // 			dataType: 'json',
    // 			data: {tugas_id: tugas_id, name: name, no_hp: no_hp, alamat:alamat, 
    //                 nominal: nominal, tanggal_transaksi: tanggal_transaksi, image_path:image_path, sign_path:sign_path},
    // 		})
    // 		.done(function(data) {
    // 			if (data > 0) {
    // 				alert('insert data sukses');
