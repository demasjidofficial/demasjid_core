        ...
        <div class="row">
            <div class="col-md-7">
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <?= form_dropdown('sitepage_id', $pageItems, old('sitepage_id', $data->sitepage_id ?? ''), "class='form-control select2bs4 add-begin-option' data-label='".lang('crud.pages')."'") ?>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <div class="justify-content-center photo-wrapper">
                                <img id="slider_imgpreview"
                                    src="<?= (isset($data->path_image)) ? site_url($data->path_image) : $blank_img ?>"
