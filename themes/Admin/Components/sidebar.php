<aside class="main-sidebar elevation-4">
    ...
    <a href="/<?= ADMIN_AREA ?>" class="brand-link">
      <img src="<?= assetUrl("admin/images/demasjid-logo-icon.png"); ?>" alt="" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<?= assetUrl("admin/images/user.png"); ?>" class="img-circle elevation-2" alt="">
        </div>
        <div class="info">
